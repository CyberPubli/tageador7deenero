...
window.urlDetector = {
  ...
  detectarMensajeDeCarga() {
    ...
    const patronesDeteccion = [
      // Frase completa principal (con variantes de números)
      ...
      // Palabras clave individuales (como fallback)
      'acreditacion',
      'acredit4cion',
      'acredit4ci0n',
      'acr3ditacion',
    ...
    for (const message of allMessages) {
      ...
      console.log(`📝 [Carga] Texto encontrado (primeros 100 chars): "${textoNormalizado.substring(0, 100)}"`);
      ...
      links.forEach(link => {
        ...
        if (href && (href.startsWith('https://fb.me') || href.includes('instagram.com/p/'))) {
          ...
          if (timeContainer) {
            ...
            // ✅ SIMPLIFICADO: Aceptar TODAS las URLs encontradas sin filtrar por fecha
            // Si tiene timestamp, es válido
            urlsDeHoy.push({
              url: href,
              timeInfo: timeInfo,
              messageIndex: index
